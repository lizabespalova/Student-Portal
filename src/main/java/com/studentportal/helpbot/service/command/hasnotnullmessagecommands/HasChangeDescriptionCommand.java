...
@Component
public class HasChangeDescriptionCommand extends HasNotNullMessageCommands{
    public HasChangeDescriptionCommand(Helpbot helpbot, CustomerRepository customerRepository, RoomsRepository roomsRepository) {
    ...
    public boolean apply(Update update) {
        ...
        return user_sms.equals(Text.change_description);
    }
}
